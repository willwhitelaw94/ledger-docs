(function() {
  const screens = [
    { id: 1, short: 'Workspace Switcher', file: '01-workspace-switcher.html' },
    { id: 2, short: 'Stage 1 — Entity & ABN', file: '02-stage1-entity-abn.html' },
    { id: 3, short: 'Stage 2 — Simple Mode', file: '03-stage2-simple.html' },
    { id: 4, short: 'Stage 2 — Advanced Mode', file: '04-stage2-advanced.html' },
    { id: 5, short: 'Stage 3 — CoA Review', file: '05-stage3-coa-review.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">013-WSP Workspace Entity Setup</h1>
          </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <button id="figma-copy-all-btn" class="flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-md font-medium bg-gray-700/80 text-gray-300 cursor-pointer border border-gray-600 hover:bg-gray-600 hover:text-white">
            ${figmaIcon} Copy All
          </button>
          <button id="figma-select-btn" class="flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-md font-medium bg-gray-700/80 text-gray-300 cursor-pointer border border-gray-600 hover:bg-gray-600 hover:text-white">
  ...
  hints.innerHTML = `
    ...
    <span><kbd class="bg-gray-700 px-1.5 py-0.5 rounded text-gray-400 font-mono text-[10px]">1</kbd>–<kbd class="bg-gray-700 px-1.5 py-0.5 rounded text-gray-400 font-mono text-[10px]">5</kbd> Jump</span>
    <span class="text-gray-700">|</span>
  ...
  document.getElementById('figma-copy-btn').addEventListener('click', copyToFigma);
  document.getElementById('figma-copy-all-btn').addEventListener('click', function() {
    window.location.href = screens[0].file;
  });
  document.getElementById('figma-select-btn').addEventListener('click', function() {
    window.location.hash = 'figmaselector=*'; window.location.reload();
  });

...
(function() {
  const screens = [
    { id: 1, short: 'Dashboard Cards', file: '01-dashboard-checkins.html' },
    { id: 2, short: 'Completion Page', file: '02-checkin-completion.html' },
    { id: 3, short: 'Completion Report', file: '03-completion-report.html' },
    { id: 4, short: 'Risk Questions Tab', file: '04-risk-questions-tab.html' },
    { id: 5, short: 'Failed Attempt', file: '05-failed-attempt.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Care Partner Check-Ins (CHK)</h1>
          </div>

...
(function() {
  const screens = [
    { id: 1, short: 'Record List', file: '01-record-list.html' },
    { id: 2, short: 'Record Detail', file: '02-record-detail.html' },
    { id: 3, short: 'Create Form', file: '03-create-form.html' },
    { id: 4, short: 'Stage Management', file: '04-stage-management.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Feedback Records (COM)</h1>
          </div>

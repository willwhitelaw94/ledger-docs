...
(function() {
  const screens = [
    { id: 1, short: 'Xero Classic', file: '01-xero-classic.html' },
    { id: 2, short: 'Full-Width Compact', file: '02-full-width-compact.html' },
    { id: 3, short: 'Card Sections', file: '03-card-sections.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">SBS Bill Form V3</h1>
          </div>
    ...
    overlay.innerHTML = `
      <div class="bg-gray-800 rounded-xl border border-gray-700 shadow-2xl p-8 max-w-md w-full mx-4 text-center">
        <div class="w-12 h-12 bg-[#007F7E] rounded-full flex items-center justify-center mx-auto mb-4">
          <svg width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
        </div>

// Shared Mockup Viewer Toolbar — single toolbar for all LES mockup pages
// Uses Tailwind classes (already loaded on each page)
(function() {
  const screens = [
    { id: 1, short: 'Overview', file: '01-lead-profile-overview.html' },
    { id: 2, short: 'Timeline', file: '02-lead-profile-timeline.html' },
    { id: 3, short: 'Other', file: '03-lead-profile-other.html' },
    { id: 4, short: 'Quick Create', file: '04-quick-create-modal.html' },
    { id: 5, short: 'Guided Create', file: '05-guided-create-stepper.html' },
    { id: 6, short: 'Stage Wizard', file: '06-journey-stage-wizard.html' },
    { id: 7, short: 'Status Wizards', file: '07-status-wizards.html' },
    { id: 8, short: 'Consumer', file: '08-consumer-profile.html' },
    { id: 9, short: 'List View', file: '09-list-view.html' },
    { id: '★', short: 'Shell Preview', file: '01-lead-profile-overview-shell.html' },
  ];
  ...
  // Note: figmacapture param is required alongside figmaselector for the capture script to initialize
  if (window.location.hash.includes('figmaselector')) {
    // Ensure figmacapture is in the hash — required by capture.js to enter selection flow
    if (!window.location.hash.includes('figmacapture')) {
      history.replaceState(null, '', window.location.pathname + '#figmacapture&figmaselector=*');
    }
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Lead Essential (LES)</h1>
          </div>
  ...
  // ===== Select Elements =====
  // Reloads page with figmacapture + figmaselector=* — both required by capture.js
  function openSelector() {
    window.location.hash = 'figmacapture&figmaselector=*';

...
(function() {
  const screens = [
    { id: 1, short: 'Table View', file: '01-table-view.html' },
    { id: 2, short: 'Kanban Board', file: '02-kanban-board.html' },
    { id: 3, short: 'Task Modal', file: '03-task-modal.html' },
    { id: 4, short: 'Inline Editing', file: '04-inline-editing.html' },
    { id: 5, short: 'Keyboard Shortcuts', file: '05-keyboard-shortcuts.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Task Management MVP</h1>
          </div>

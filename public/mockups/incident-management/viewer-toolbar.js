...
(function() {
  const screens = [
    { id: 1, short: 'Create Wizard', file: '01-create-wizard.html' },
    { id: 2, short: 'Incident Detail', file: '02-incident-detail.html' },
    { id: 3, short: 'Package Tab', file: '03-package-incidents.html' },
    { id: 4, short: 'Global List', file: '04-global-incidents.html' },
    { id: 5, short: 'Public Form', file: '05-public-form.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">ICM Incident Management</h1>
          </div>
  ...
  function runCapture(onComplete) {
    toolbar.style.display = 'none'; hints.style.display = 'none'; document.body.style.paddingTop = '0'; document.documentElement.style.setProperty('--toolbar-h', '0px');
    ...
    script.onload = function() {
      setTimeout(function() {
        toolbar.style.display = ''; hints.style.display = ''; document.body.style.paddingTop = visible ? '88px' : '0'; document.documentElement.style.setProperty('--toolbar-h', visible ? '88px' : '0px');
